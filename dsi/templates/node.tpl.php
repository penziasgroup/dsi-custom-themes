...
if(isset($panel_bg_path)){
    $background_url = 'url(' . $panel_bg_path . ')';
    $background_style = 'style="background-image:' . $background_url . '"';
}

?>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?><?php print $background_style; ?>>
